<div class="llcw_rewrite_rules">
    ...
    <?php if( llcw_get_server_software() == 'nginx' ){ ?>
        <div class="notice notice-info">
            <p><?php echo esc_html__( "Notice! When deactivating this plugin don't forget to remove the following nginx rules and reload your nginx server. WordPress doesn't have access to do this automatically.", 'll-cookie-wall' ) ?></p></div>
