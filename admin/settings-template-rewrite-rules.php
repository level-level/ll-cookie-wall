<div class="llcw_rewrite_rules">
    ...
    <?php if( llcw_get_server_software() == 'apache' ){ ?>
        ...
        <pre style="overflow:scroll; border: 1px solid #ccc;">
            <?php echo esc_html( llcw_read_config_file( $apache_config_path ) ); ?>
        </pre>
    <?php } ?>
    ...
    <?php if( llcw_get_server_software() == 'nginx' ){ ?>
        ...
        <pre style="overflow:scroll; border:1px solid #ccc;">
            <?php echo esc_html( llcw_read_config_file( $nginx_config_path ) ); ?>
        </pre>
    <?php } ?>
